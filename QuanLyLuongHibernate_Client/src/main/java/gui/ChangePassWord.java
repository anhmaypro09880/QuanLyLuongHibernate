...
public class ChangePassWord extends javax.swing.JFrame {
    ...
    public ChangePassWord(NhanVien tk) {
        initComponents();
...
//        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
    ...
    private void btnOKMouseClicked(java.awt.event.MouseEvent evt) throws RemoteException {//GEN-FIRST:event_btnOKMouseClicked
...
//    			ChamCongNVHC_DAO dlieu = new ChamCongNVHC_DAO();
    			NhanVien tk2 = new NhanVien(userN, pass);
    			NhanVien nv = App.nvDao.GetNVTheoMa(userN);
    			...
    			PhongBan pb = App.nvDao.getPhongBan(maPB);
    			String mkmoi = passWord1.getText();
    			NhanVien nvnew = new NhanVien(maNV, tenNV, nv.getNgaySinh(), nv.getNgayVaolam(), CMND, SDT, nv.isTrangThai(), nv.isQuanLy(), nv.isGioiTinh(),mkmoi,pb);
    			
    			if(mkCu.equals(pass)) {
    				if( String.valueOf(this.passWord1.getPassword()).equals(String.valueOf(this.passWord2.getPassword()))){
    						 
        					App.nvDao.doiMatKhau(nvnew);
