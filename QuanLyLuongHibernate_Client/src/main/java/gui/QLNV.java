...
public class QLNV extends javax.swing.JPanel implements ActionListener, MouseListener{
	...
	private 	PhongBanDao pbdao = App.pbDao;
	private NhanVienDao nvdao = App.nvDao; 
    /**
     * Creates new form QLNV
     * @throws RemoteException 
     */
    public QLNV() throws RemoteException {
        initComponents();
        ...
        List<NhanVien> ds = (ArrayList<NhanVien>) nvdao.getNVDangLam();
...
//    PhongBan_DAO pb_dao = new PhongBan_DAO();
    ArrayList<NhanVien> dsnv = (ArrayList<NhanVien>) nvdao.getNVall();
    /**
...
//			JOptionPane.showMessageDialog(null, pbdao.getPBten(phBan));
			...
			if(txtTen.getText().equals("") | txtSDT.getText().equals("") |  txtCMND.getText().equals("") )
				...
				try {
					if(ktraten()&&ktrans()&&ktranvl()&&ktraNamNu()&&ktrasdt(SDT)&&ktracmnd(CMND))
					{
...
//		cbPb.setSelectedItem(pb_dao.getPBten(jTable1.getValueAt(row, 7).toString()).getTenPB());
	...
	public String taoMaNhanVien() throws RemoteException {
		...
		NhanVien nv =nvdao.getNVCuoiHC();
			...
			{
				String maCuoi = nvdao.getNVCuoiLD().getMaNV();
				long so = Long.parseLong(maCuoi.substring(2)) + 1000000 + 1;
				String soMoi = ("" + so).substring(1);
				return "LD" + soMoi;
			}
	...
	public boolean ktrasdt(String SDT) throws RemoteException
	{	
		String reg="[0-9]{9,10}";
		if(SDT.equals(null))
		{
	...
	public boolean ktracmnd(String CMND) throws RemoteException
	{
	String reg="[0-9]{9}";
	if(CMND.equals(null))
	{
